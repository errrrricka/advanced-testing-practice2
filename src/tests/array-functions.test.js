import {map,filter, find, findLast, head, sort, reverse} from "../services/array-functions";
...
describe("filter function", () => {
  it("should return all names of length 3 in array", () => {
...
describe("find function", () => {
  it("should return the name Barney only", () => {
